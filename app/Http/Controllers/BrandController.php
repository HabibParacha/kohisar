...
class BrandController extends Controller
{
    ...
    //                 'success' => false,
    //                 'message' => $validator->errors()->first(),
    //             ], 422); // Validation errors typically return 422 Unprocessable Entity
    //         }

    //         // Store request data, excluding the image (handled separately)
    //         $data = $request->except('image');

    //         // Create the Brand record
    //         $brand = Brand::create($data);

    //         // Handle the image upload using Spatie Media Library
    //         if ($request->hasFile('image')) {
    //             // Use the Media Library to add the image to the brand's media collection
    //             $brand->addMedia($request->file('image'))
    //                 ->toMediaCollection('images'); // 'images' is the collection name, you can change it
    //         }
