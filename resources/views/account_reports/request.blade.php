                        ...
                        <!-- enctype="multipart/form-data" -->
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mt-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="startDate" value="{{ old('startDate') }}" id="StartDate" class="form-control" required>
                                                <div id="start"></div>
                                            </div>
                                            <div class="form-group mt-2">
                                                <label for="EndDate">End Date</label>
                                                <input type="date" name="endDate" id="EndDate" value="{{ old('EndDate') }}" class="form-control" required>
                                                <div id="end"></div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane col-12 col-md-4" id="tab-customer-ledger" role="tabpanel">
                                    <div class="mb-1 mt-1">
                                        <label >Customers</label>
                                        <select name="customer_id_1" class="select2 form-control" style="width: 100%">
                                ...
                                <div class="tab-pane col-12 col-md-4" id="tab-supplier-ledger" role="tabpanel">
                                    <div class="mb-1 mt-1">
                                        <label >Suppliers</label>
                                        <select name="supplier_id_1" class="select2 form-control" style="width: 100%">
                                            <option value="">Choose..</option>
                                            @foreach ($suppliers as $supplier)
                                                <option value="{{ $supplier->id }}">{{ $supplier->business_name }}</option>
                                            @endforeach
