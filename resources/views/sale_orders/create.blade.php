    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                ...
                <!-- start page title -->
                <form id="sale-order-store" action="{{ route('sale-order.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                    ...
                    <div class="row  mt-2">
                        ...
                        <div class="col-md-8 text-end">
                            <button type="submit" id="submit-sale-order-store" class="btn btn-success w-md">Save</button>
...
<script>  
    ...
    $('#sale-order-store').on('keydown', function(e) {
        if (e.key === 'Enter') {
...
<script>
    $('#sale-order-store').on('submit', function(e) {
        e.preventDefault();
        var submit_btn = $('#submit-sale-order-store');
        let createformData = new FormData(this);
        $.ajax({
            type: "POST",
            url: "{{ route('sale-order.store') }}",
            dataType: 'json',
            contentType: false,
            processData: false,
            cache: false,
            ...
            success: function(response) {
                ...
                if(response.success == true){
                    $('#sale-order-store')[0].reset();  // Reset all form data
