                    ...
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right d-flex">
                                ...
                                <div class="page-btn">
                                    <a href="#" class="btn btn-added btn-primary" data-bs-toggle="modal" data-bs-target="#add-brand"><i class="me-2"></i>Add New Brand</a>
                                </div>  
                            </div>
                                ...
                                <div class="modal-body custom-modal-body">
                                    <form id="brand-store" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-footer-btn">
                                            ...
                                            <button type="submit" id="submit-brand-store" class="btn btn-submit btn-primary">Create Brand</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="content">
                                ...
                                <div class="modal-body custom-modal-body">
                                    <form id="brand-update" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="id" id="brand_id"> <!-- Hidden field to store the brand ID -->
                                        <div class="mb-3">
                                            <label class="form-label">Name</label>
                                        ...
                                        <div class="modal-footer-btn">
                                            <button type="button" class="btn btn-cancel me-2 btn-dark" data-bs-dismiss="modal">Cancel</button>
                                            <button type="submit" id="submit-brand-update" class="btn btn-submit btn-primary">Update Brand</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                        ...
                        <div class="content">
                            <div class="modal-header border-0 custom-modal-header">
                                ...
                                <div class="modal-footer-btn p-3 mt-2">
                                    ...
                                    <button type="button" class="btn btn-submit shadow-sm btn-danger" id="submit-brand-destroy">Delete</button>
                                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#brand-update').on('submit', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('brand.update', ':id') }}".replace(':id', brand_id), // Using route name
                    dataType: 'json',
                    contentType: false,
                    processData: false,
                    cache: false,
            ...
            $('#submit-brand-destroy').click(function() {
                ...
                $.ajax({
                    type: 'DELETE',
                    url: "{{ route('brand.destroy', ':id') }}".replace(':id', brand_id), // Using route name
                    data: {
